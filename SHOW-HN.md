# Show HN: Vibepity - Open-source AI agent using your ChatGPT subscription ($0 API cost)

**URL**: https://github.com/vibepity/vibepity

I built Vibepity, an open-source AI agent that uses your existing ChatGPT Plus subscription instead of API keys. $0 additional cost.
...
## What Vibepity does differently
...
```bash
npx vibepity onboard   # 5-step setup wizard
vibepity chat           # Start chatting
vibepity proxy start    # API proxy for other tools
vibepity daemon install # 24/7 background mode
```
...
Title: **Vibepity: Open-source AI agent that uses your ChatGPT subscription instead of API keys - OpenClaw alternative with security built in**
